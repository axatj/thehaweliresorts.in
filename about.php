...
<body class="bg-lighht">
    ...
    <div class="my-5 px-4">
        <h2 class="fw-bold h-font text-center">About Director</h2>
        <div class="h-line bg-dark"></div>
        <p class="text-center mt-3">
            Mr. Swarnjeet Singh is the man behind the mission of making the haweli resort as a one stop
            solution for travellors and visitors
        </p>
    </div>
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
                <h3 class="mb-3">Story Of Haweli Resort</h3>
                <p>
                     Coming Soon.....
                </p>
            </div>
